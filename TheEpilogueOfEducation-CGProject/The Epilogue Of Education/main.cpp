...
void summary() {
	...
	// Summary Text
	print("As children, we are naive and taught to follow, not to lead. We are taught to explore.",
		1, 1, 1, summary_para1_fade, 75, 575, .125, .125, 1.25);
	print("We are taught to learn by heart, not to understand.",
		1, 1, 1, summary_para1_fade, 75, 550, .125, .125, 1.25);

	print("When we grow up, things change. If We are dont understand we will not be able to succeed ",
		1, 1, 1, summary_para2_fade, 75, 475, .125, .125, 1.25);
	print("Every person wants to be a Doctor or an Engineer, and the rest` of the options are at bleak focus. ",
	...
	print("Ending up as an engineer has become a Choice choosen by Most. ",
		1, 1, 1, summary_para3_fade, 75, 350, .125, .125, 1.25);

	print("Engineering is a field to invent and innovate.",
...
void engineeringCollege() {
	...
	print("Students take up Engineering based on their passion or were forced to take",
...
void workplace() {
	...
	print("Eventually, most engineers irrespective of his/her branch end up in an IT job",
